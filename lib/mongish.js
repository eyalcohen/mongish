    ...
    Step(
      function () {
        self.db.collection(name, _.bind(function (err, _col) {
          ...
          col = _col;
          if (_.endsWith(col.collectionName, 'y') &&
              !_.endsWith(col.collectionName, 'ey')) {
            exports[_.capitalize(_.strLeftBack(col.collectionName, 'y')) + 'ies'] = col;
          } else {
